...
\input{Sections/1_Einleitung.tex}
\input{Sections/2_Projektkontext.tex}
\input{Sections/3_Designprinzipien.tex}
\input{Sections/4_UI-Elemente.tex}
\input{Sections/5_User Flows und Interaktionen.tex}
\input{Sections/6_Barrierefreiheit.tex}
\input{Sections/7_Technische Umsetzung.tex}
\input{Sections/8_Learnings.tex}
