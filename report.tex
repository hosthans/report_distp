...
\input{Sections/Projektkontext.tex}
\input{Sections/Designprinzipien.tex}
\input{Sections/UI-Elemente.tex}
\input{Sections/User Flows und Interaktionen.tex}
\input{Sections/Barrierefreiheit.tex}
\input{Sections/Technische Umsetzung.tex}
\input{Sections/Learnings.tex}
